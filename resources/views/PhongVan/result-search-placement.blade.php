        ...
        <div class="container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <span class="input-group-text h5 p-0 bg-transparent border-0 pr-2 pr-sm-3" id="basic-addon1"><i
                                        class="mdi mdi-magnify"></i></span>
                                            ...
                                            <input name="search" value="{{ $search ? $search : ''}}" id="valueSearch" type="search" class="form-control" placeholder="Search tên học viên" aria-label="Tìm marketing">
                                        </div>
                                    </form>
                                </div>
            ...
            @endif -->
                            ...
                            <table class="table table-striped table-bordered zero-configuration">
                                ...
                                @php $i=1; $j=0; @endphp
                                @foreach($placementTests as $item)
                                    <tr>
