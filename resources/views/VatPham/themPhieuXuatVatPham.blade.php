                ...
                <div class="card">
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-sm-6">
                                <label>Ghi chú</label>
                                <textarea maxlength="200"  class="form-control" name="ghiChu"></textarea>
                            </div>
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <select  class="js-example-responsive" style="width:100%" id="sanPham" name="sanPham">
                                    ...
                                    <option value="{{$item->item_id}}">{{$item->item_name}} ({{$item->inventoryItem_amount}})</option>
                                    @endforeach
                                </select>
...
function myFunction() {
 ...
 $(".js-example-responsive").select2({
    ...
    function thayDoiChiNhanh()
    {
        ...
        $.ajax({
            type: 'get',
            url: '{{ route("getChangeChiNhanhPhieuXuatVatPham")}}',
            data:{
                'id':$id
            },
...
function btnThem()
    {
     ...
     function themSanPham(id,soLuong1) {
      ...
      $('#myform1').submit(function() {
        $.ajax({
            type: 'Post',
            url: '{{ route("postThemPhieuXuatVatPham")}}',
