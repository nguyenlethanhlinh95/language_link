                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-6">
                            @if(session('quyen242')==1)
                            <a href="{{route('getThemPhieuNhapVatPham')}}"><button type="button" class="btn mb-1 btn-outline-success" 
                        ...
                        <table class="table table-striped table-bordered ">
                            ...
                            <tbody id="duLieuSearch">
                                @php $i=1; @endphp
                                @foreach($PhieuNhapVatPham as $item)
                                <tr>
                                    ...
                                    @if(session('quyen243')==1)
                                    <td><a class="btn" href="{{route('getCapNhatPhieuNhapVatPham')}}?id={{$item->warehousingItem_id}}" >
...
<script>
    function getChiTiet(id)
    {
        $.ajax({
            type: 'get',
            url: '{{route("getChiTietPhieuNhapVatPham")}}',
            data: {
                'id': id
            },
    ...
    $.ajax({
        type: 'get',
        url: '{{ route("searchPhieuNhapVatPham")}}',
        data: {
            'value': $value,
            'page': 1
        },
        ...
        swal({
            ...
            function(e) {
                e ? swal(
                        $.ajax({
                            type: 'get',
                            url: '{{route("getXoaPhieuNhapVatPham")}}',
                            data: {
                                'id': id
                            },
                            success: function(data) {
