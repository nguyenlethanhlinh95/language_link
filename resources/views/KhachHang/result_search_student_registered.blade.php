                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <form method="get" action="{{ route('result-search-student-registerd') }}">
                                        ...
                                        <div class="input-group icons">
                                            <input value="{{ $keyword ? $keyword : '' }}" name="q" id="valueSearch" type="search" class="form-control" placeholder="Search tên học viên" aria-label="Tìm marketing">
                                        ...
                                        <tbody id="duLieuGhiDanh">
                                            ...
                                            @foreach($students as $student)
                                                <tr>
                                                    <td>{{ $i }}</td>
                                                    <td>
                                                        <a href="{{ route('getChiTietHocVien', ['id'=> $student->student_id]) }}">{{ $student->student_firstName . ' ' . $student->student_lastName }}</a>
                                                    </td>
                                                    <td></td>
                                                    <td>{{ $student->student_parentName }}</td>
                                                    <td>{{ $student->student_parentPhone }}</td>
                                                    <td>{{ $student->student_phone }}</td>
                                                    <td>{{ $student->student_address }}</td>
                                                    @if (session('quyen32') == 1)
                                                    <td>
                                                        <a class="btn" href="{{ route('getThemPhongVan', ['id'=>$student->student_id]) }}"><i style="color: blue" class="fa fa-pencil"></i></a>
                                                    </td>
                                                    @endif
                                                </tr>
                                                @php $i=$i+1; @endphp
                                                ...
                                                <form id="myform1" autocomplete="off" action="" enctype="multipart/form-data" method="post">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 col-sm-6">
                                                            ...
                                                            <input required maxlength="200" name="link" id="link type="text"  class="form-control" >
                                                        </div>
                                                        <div class="col-lg-6 col-sm-6">
