                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div style="text-align: center">
                            ...
                            <p>( {{ date('M.d',strtotime($ngayBatDauChinh)) }} - {{ date('M.d',strtotime($ngayKetThucChinh)) }} )</p>
                        </div>
                        <div class="row">
                            <div class="col-lg-2 col-sm-6">
                                ...
                                <div>
                                    ...
                                    <a href="{{route('getXepLicVanPhong')}}?id={{$nhanVien->employee_id}}&week={{$tuan-1}}"> 
                        ...
                        <table class="table  table-bordered ">
                            <thead>
                                <th></th>
                                <th>T2<br>( {{ date('M.d',strtotime($ngayBatDauChinh)) }})</th>
                                <th>T3<br>( {{ date('M.d',strtotime($ngayThu3)) }})</th>
                                <th>T4<br>( {{ date('M.d',strtotime($ngayThu4)) }})</th>
                                <th>T5<br>( {{ date('M.d',strtotime($ngayThu5)) }})</th>
                                <th>T6<br>( {{ date('M.d',strtotime($ngayThu6)) }})</th>
                                <th>T7<br>( {{ date('M.d',strtotime($ngayThu7)) }})</th>
                                <th>CN<br>( {{ date('M.d',strtotime($ngayKetThucChinh)) }})</th>
                            </thead>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       @foreach($arrCa as $item)
                                            @if($item['ca']==1 && $item['thu']==$i)
                                            @php $gioBatDau =$item['gioBatDau']." - ".$item['gioKetThuc']; @endphp
                                            @endif
                                       @endforeach
