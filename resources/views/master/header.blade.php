...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="images/logo-min-skytech.jpg">
    <!-- Custom Stylesheet -->
        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo" style="padding: auto">
                <a href="trang-chu">
                    <b class="logo-abbr"><img width="100%" src="images/logo-min-skytech.jpg" alt=""> </b>
                    <span class="logo-compact">< width="100%"img src="images/logo-min-skytech.jpg" alt=""></span>
                    <span class="brand-title">
                        <img width="100%" src="images/logo-text-skytech.png" alt="">
                    </span>
                </a>
            </div>
        </div>
            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <!-- <li class="mega-menu mega-menu-sm">
                        ...
                        <ul aria-expanded="false">
                            <li><a class="itemLi" href="./layout-blank.html">Blank</a></li>
                            <li><a class="itemLi" href="./layout-one-column.html">One Column</a></li>
                            <li><a class="itemLi" href="./layout-two-column.html">Two column</a></li>
                            <li><a class="itemLi" href="./layout-compact-nav.html">Compact Nav</a></li>
                            <li><a class="itemLi" href="./layout-vertical.html">Vertical</a></li>
