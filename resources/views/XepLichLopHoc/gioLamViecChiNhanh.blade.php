            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <form id="myform1" autocomplete="off" action="{{ route('postTimGioChiNhanh') }}"  enctype="multipart/form-data" method="post">
                            {{ csrf_field() }}
                        <div class="row"><input hidden id="id" name="id" value="{{ $chiNhanh->branch_id }}">
                            <div class="col-lg-6 col-sm-6">
                               <p style="font-size: 20px">Branch: <b>{{ $chiNhanh->branch_name }}</b></p>
                            </div>
                            <div class="col-lg-6 col-sm-6" >
            ...
            printpage.document.write('<body onLoad="self.print()">'+
                ...
                '  <div style="text-align: center">'+
                        ...
                        '<div style="display:inline-block;width:50%">'+
                            '<p style="font-size: 20px"><b>Branch:</b> {{$chiNhanh->branch_name}} </p>'+
                        '</div>'+
