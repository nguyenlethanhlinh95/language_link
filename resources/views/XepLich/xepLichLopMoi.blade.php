                        ...
                        <form id="myform1" autocomplete="off" action="" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-6">
                                    ...
                                    <input required maxlength="100" class="form-control" name="ten" id="ten" value="">
                                </div>
                                <div class="col-lg-3 col-sm-6">
                                    <label>branch <span style="color: red">*</span></label>
                                    <select required class="form-control" id="chiNhanh" name="chiNhanh" onchange="changeCoSo();">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                   ...
                                   <input class="form-control" readonly id="ngayKetThuc" name="ngayKetThuc" value="">
                                </div>
                                <div class="col-lg-3 col-sm-6">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <label>Giờ buổi học <span style="color: red">*</span></label>
                                   <div class="input-group clockpicker">
                                    <input required type="text" class="form-control" value="02:00" onchange ="kiemTraGioHoc();"  name="gioBuoiHoc" id="gioBuoiHoc" > 
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-2 col-sm-6">
                                        ...
                                        <div class="input-group clockpicker">
                                            <input required type="text" class="form-control" value="09:00" onchange ="kiemTraGioHoc();"  name="gioBatDau2" id="gioBatDau2" value=""> 
                                            <span class="input-group-append"><span class="input-group-text">
                                                <i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    ...
                                    <div class="col-lg-2 col-sm-6">
                                        ...
                                        <div class="input-group clockpicker">
                                            <input readonly required type="text" class="form-control" value="11:00"  onchange="kiemTraGioHoc();" name="gioKetThuc2" id="gioKetThuc2" value=""> 
                                            <span class="input-group-append"><span class="input-group-text">
                                                <i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                     ...
                                     <div class="col-lg-2 col-sm-6">
                                        <label>Start time</label>
                                        <div class="input-group clockpicker">
                                            <input required type="text" class="form-control" value="09:00" onchange ="kiemTraGioHoc();"  name="gioBatDau3" id="gioBatDau3" value=""> 
                                            <span class="input-group-append"><span class="input-group-text">
                                                <i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    ...
                                    <div class="col-lg-2 col-sm-6">
                                        <label>End time</label>
                                        <div class="input-group clockpicker">
                                            <input readonly required type="text" class="form-control" value="11:00"  onchange="kiemTraGioHoc();" name="gioKetThuc3" id="gioKetThuc3" value=""> 
                                            <span class="input-group-append"><span class="input-group-text">
                                                <i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                     ...
                                     <div class="col-lg-2 col-sm-6">
                                        <label>Start time</label>
                                        <div class="input-group clockpicker">
                                            <input required type="text" class="form-control" value="09:00" onchange ="kiemTraGioHoc();"  name="gioBatDau4" id="gioBatDau4" value=""> 
                                            <span class="input-group-append"><span class="input-group-text">
                                                <i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    ...
                                    <div class="col-lg-2 col-sm-6">
                                        <label>End time</label>
                                        <div class="input-group clockpicker">
                                            <input  readonly required type="text" class="form-control" value="11:00"  onchange="kiemTraGioHoc();" name="gioKetThuc4" id="gioKetThuc4" value=""> 
                                            <span class="input-group-append"><span class="input-group-text">
                                                <i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                     ...
                                     <div class="col-lg-2 col-sm-6">
                                        <label>Start time</label>
                                        <div class="input-group clockpicker">
                                            <input  required type="text" class="form-control" value="09:00" onchange ="kiemTraGioHoc();"  name="gioBatDau5" id="gioBatDau5" value=""> 
                                            <span class="input-group-append"><span class="input-group-text">
                                                <i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    ...
                                    <div class="col-lg-2 col-sm-6">
                                        <label>End time</label>
                                        <div class="input-group clockpicker">
                                            <input readonly required type="text" class="form-control" value="11:00"  onchange="kiemTraGioHoc();" name="gioKetThuc5" id="gioKetThuc5" value=""> 
                                            <span class="input-group-append"><span class="input-group-text">
                                                <i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                     ...
                                     <div class="col-lg-2 col-sm-6">
                                        <label>Start time</label>
                                        <div class="input-group clockpicker">
                                            <input required type="text" class="form-control" value="09:00" onchange ="kiemTraGioHoc();"  name="gioBatDau6" id="gioBatDau6" value=""> 
                                            <span class="input-group-append"><span class="input-group-text">
                                                <i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    ...
                                    <div class="col-lg-2 col-sm-6">
                                        <label>End time</label>
                                        <div class="input-group clockpicker">
                                            <input readonly required type="text" class="form-control" value="11:00"  onchange="kiemTraGioHoc();" name="gioKetThuc6" id="gioKetThuc6" value=""> 
                                            <span class="input-group-append"><span class="input-group-text">
                                                <i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                     ...
                                     <div class="col-lg-2 col-sm-6">
                                        <label>Start time</label>
                                        <div class="input-group clockpicker">
                                            <input required type="text" class="form-control" value="09:00" onchange ="kiemTraGioHoc();"  name="gioBatDau7" id="gioBatDau7" value=""> 
                                            <span class="input-group-append"><span class="input-group-text">
                                                <i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    ...
                                    <div class="col-lg-2 col-sm-6">
                                        <label>End time</label>
                                        <div class="input-group clockpicker">
                                            <input readonly required type="text" class="form-control" value="11:00"  onchange="kiemTraGioHoc();" name="gioKetThuc7" id="gioKetThuc7" value=""> 
                                            <span class="input-group-append"><span class="input-group-text">
                                                <i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                     ...
                                     <div class="col-lg-2 col-sm-6">
                                        <label>Start time</label>
                                        <div class="input-group clockpicker">
                                            <input required type="text" class="form-control" value="09:00" onchange ="kiemTraGioHoc();"  name="gioBatDau8" id="gioBatDau8" value=""> 
                                            <span class="input-group-append"><span class="input-group-text">
                                                <i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    ...
                                    <div class="col-lg-2 col-sm-6">
                                        <label>End time</label>
                                        <div class="input-group clockpicker">
                                            <input readonly required type="text" class="form-control" value="11:00"  onchange="kiemTraGioHoc();" name="gioKetThuc8" id="gioKetThuc8" value=""> 
                                            <span class="input-group-append"><span class="input-group-text">
                                                <i class="fa fa-clock-o"></i></span></span>
                                        </div>
                                    </div>
    ...
    function changeCTH()
    {
        ...
        $.ajax({
            ...
            success: function(data) {
               ...
               // document.getElementById('duLieuCTH').innerHTML = data[0]['khoaHoc'];
                kiemTraGioHoc();
            }
        });
