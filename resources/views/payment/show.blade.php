        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Xóa phiếu chi</h4>
                            ...
                            <form action="{{ route('payment.delete', ['id'=>$payment->payment_id]) }}" method="post" autocomplete="off">
                                {{ csrf_field() }}
                                <div class="col-lg-12 col-sm-12 pl-0">
                                    <div class="mt-4">
                                        <button type="submit" class="btn mb-1 btn-outline-danger">Bạn có muốn xóa phiếu chi này?</button>
                                        <a href="{{ route('payment.index') }}" class="btn mb-1 btn-outline-secondary">Hủy?</a>
                                    </div>
                                </div>
                                <div class="row">
