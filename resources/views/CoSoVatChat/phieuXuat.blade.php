                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-6">
                            @if(session('quyen182')==1)
                            <a href="{{route('getThemPhieuXuatKho')}}"><button type="button" class="btn mb-1 btn-outline-success" 
                        ...
                        <table class="table table-striped table-bordered ">
                            ...
                            <tbody id="duLieuSearch">
                                ...
                                <tr>
                                    ...
                                    @if(session('quyen183')==1)
                                    <td><a class="btn" href="{{route('getCapNhatPhieuXuatKho')}}?id={{$item->deliveryBill_id}}" >
