                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody id="duLieuSearch">
                                ...
                                <tr>
                                    ...
                                    <td>{{ date('H:i d/m/Y',strtotime($item->student_dateTime)) }}</td>
...
<form id="myform1" autocomplete="off" action="{{ route("searchThongKeHocVien")}}" enctype="multipart/form-data" method="post">
    {{ csrf_field() }}
