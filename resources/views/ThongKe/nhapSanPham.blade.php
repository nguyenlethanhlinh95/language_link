        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Thống kê nhập vật phẩm </h4>
                        <br>
                        <div class="row">
...
<form id="myform1" autocomplete="off" action="{{ route("searchThongNhapSanPham")}}" enctype="multipart/form-data" method="post">
    {{ csrf_field() }}
