...
Route::get('cap-nhat-du-lieu-phong-van', 'phongVanController@postCapNhatPhongVan')->name('postCapNhatPhongVan');
...
Route::get('result-search-plan-phong-van', 'phongVanController@resultSearchPlanPhongVan')->name('result-search-plan-phong-van');
